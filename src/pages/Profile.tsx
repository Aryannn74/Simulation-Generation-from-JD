...
const Profile = () => {
  ...
  const handleSave = () => {
    setEditing(false);
    // Here you can add API call to persist data
  };
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-3">
                    HR Manager • Document Specialist
                  </p>
                ...
                <div>
                  ...
                  {editing ? (
                    <input
                      ...
                      className="w-full p-2 rounded-md border focus:ring-1 focus:ring-primary focus:outline-none"
                    />
                  ) : (
